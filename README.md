...
- **预装常用插件**：启动时把 open-editor、diff-review、account-login、agent-preset-compat、webview-compat 装进 DSH profile，并做版本跟踪与升级；上一个版本预装的 file-changes 与 subagent-max 会在升级时自动移除。
